        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[300px]">
          ...
          <div className="md:col-span-8 md:row-span-2 relative group overflow-hidden rounded-xl bg-surface-container shadow-xl border border-white/5">
            ...
            <div className="absolute bottom-0 left-0 p-10 z-10 w-full">
              <h3 className="text-4xl font-extrabold headline-anchor mb-4">DESKTOP SERIES 03</h3>
          ...
          <div className="md:col-span-4 md:row-span-1 relative group overflow-hidden rounded-xl bg-surface-container-high border border-white/5 flex flex-col justify-end">
            ...
            <div className="absolute top-0 right-0 p-6 z-10">
              <span className="bg-primary/20 text-primary border border-primary/20 backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-tighter">Limited</span>
            </div>
            <div className="relative z-10 p-8 h-full flex flex-col justify-end">
              ...
              <div className="flex items-center justify-between mt-auto">
                <p className="text-primary font-bold text-lg">{new Intl.NumberFormat("fr-FR").format(349 * 5000)} Ar</p>
                <button className="px-4 py-2 bg-white/5 hover:bg-primary/20 border border-white/10 hover:border-primary/40 rounded-full text-[10px] font-bold uppercase tracking-widest transition-all duration-300 active:scale-95 text-white">
                  Add to cart
                </button>
              </div>
            </div>
          ...
          <div className="md:col-span-4 md:row-span-1 relative group overflow-hidden rounded-xl bg-gradient-to-br from-surface-container to-surface-container-low border border-white/5 flex flex-col justify-end">
             {/* eslint-disable-next-line @next/next/no-img-element */}
             <img 
              alt="Extreme Hardware Lab" 
              className="absolute inset-0 w-full h-full object-cover opacity-40 transition-transform duration-700 group-hover:scale-110" 
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuAknfmq3AJN4Q_2AGcEzSsIvqYgz83y1Uu1OPG7QxXt5mBza6WNb_BSvUTNhTxg64TNUJm7M7zQOP4H-WI1-UWuarUe6W9BFvp9sFCG0HtIILOVagryGYR27ktjXQTL1ehwc-KbhV10HljRP5ghhdORRxzYweesMllfkrIvODCgmdKqP8_UGQ14M7tJSDqN3Trc5N4NhanPajp5P0FunAP1K8ssaF1XPwHAKUKq0uQ8RSLJPjuNNnUvnAR7IhgpKSJlK0qpkhgRE-kD"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent"></div>
            <div className="relative z-10 p-8 h-full flex flex-col justify-end">
              ...
              <div className="flex items-center justify-between mt-auto">
                <p className="text-primary font-bold text-lg">{new Intl.NumberFormat("fr-FR").format(640 * 5000)} Ar</p>
                <button className="px-4 py-2 bg-white/5 hover:bg-primary/20 border border-white/10 hover:border-primary/40 rounded-full text-[10px] font-bold uppercase tracking-widest transition-all duration-300 active:scale-95 text-white">
                  Add to cart
                </button>
              </div>
      ...
      <section className="reveal bg-surface-container-lowest py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
            ...
            <Link href="/mobile" className="text-on-surface-variant hover:text-white transition-colors border-b border-outline-variant pb-1 text-sm font-light">
              Tout parcourir
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
            {[
              ...
              { id: 4, name: "VOID CURVE 49\"", color: "240Hz OLED", price: 1599, img: "https://lh3.googleusercontent.com/aida-public/AB6AXuAn8o8FAVUugmAoK4mlzGcgCWdKbi3Ir6akzwp4Nqrehe4sL_j8C6n5Z5x64oNjdabRFs7WLpAUfRRMZCIfKNmgoAhK7Wef_w4_lRRa5s0EhCVfkdCxZ9EIpjsSOMhc9E96yB4Ay1WbTkqhwfvi_p1iLqV2tEaUWwF7aROkzBxzEEg8qDjqzL3MrviNmL6nrnv5K7DLlGBql1UHmw1FM9LFQ8niJb-Phn1-Ar69AcCSt7gcBEsHATes_UDW9zHOhNICV_ACQ_40b42C" }
            ].map((p) => (
              <div key={p.id} className="group cursor-pointer">
                ...
                <div className="text-center">
                  ...
                  <p className="mt-3 font-bold text-white text-lg">{new Intl.NumberFormat("fr-FR").format(p.price * 5000)} Ar</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="reveal py-40 px-6 text-center overflow-hidden">
        <div className="max-w-4xl mx-auto">
          <div className="mb-12 flex justify-center">
            <Cpu size={64} strokeWidth={1} className="text-primary opacity-50" />
          </div>
          <h2 className="text-4xl md:text-6xl font-extrabold headline-anchor mb-8 leading-[1.1] uppercase tracking-tighter">
            Le Hardware est une <br/> <span className="italic text-primary">forme d'art.</span>
          </h2>
          <p className="text-xl md:text-2xl text-on-surface-variant font-light mb-12 leading-relaxed italic opacity-80">
            "Chez L7X Boutik, nous sélectionnons l'élite technologique. Chaque circuit, chaque panneau OLED est une pièce du futur que nous vous livrons aujourd'hui."
          </p>
      ...
      <section className="reveal max-w-7xl mx-auto px-6 mb-32">
        <div className="glass-card p-12 md:p-24 rounded-3xl border border-white/5 relative overflow-hidden text-center">
          ...
          <div className="relative z-10">
            ...
            <p className="text-on-surface-variant mb-10 max-w-lg mx-auto font-light">
              Inscrivez-vous pour recevoir les alertes sur les prochains GPU et flagship mobiles avant tout le monde.
            </p>
            <form className="flex flex-col md:flex-row gap-4 max-w-xl mx-auto" onSubmit={(e) => e.preventDefault()}>
              <input 
                className="flex-grow bg-surface-container-low border border-outline-variant/20 rounded-full px-8 py-4 focus:ring-1 focus:ring-primary focus:border-primary text-white outline-none font-light placeholder:opacity-30" 
                placeholder="Votre email" 
                type="email"
              />
              <button className="bg-white text-black font-bold px-10 py-4 rounded-full hover:bg-primary hover:text-black transition-colors active:scale-95 uppercase tracking-widest text-[10px]">
                Rejoindre
              </button>
            </form>
          </div>
